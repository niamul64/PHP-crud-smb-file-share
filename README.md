...
# see about vertual host creating: https://github.com/niamul64/linux-apache-mysql-php-LAMP
...
## project file name is: smbFileSystem
This project file is inside computer/var/www/
...
```
```
inside: sites/apache2/sites-available/000-default.conf
<VirtualHost *:80>
...
```
inside: sites/apache2/sites-available/default-ssl.conf
<IfModule mod_ssl.c>
